...
const districts: SeoIntentEntity[] = [
  ...
  district(
    ...
    ["seomyeon"],
    ["inheritance-registration", "ownership-transfer", "real-estate-registration"],
    [INSTITUTION_IDS.busanjinRegistry],
  ),
  district(
    "dong-gu",
  ...
  district(
    ...
    "영도구",
    "region-yeongdo-gu",
    ["영도구 법무사", "영도 상속등기", "영도 선박등기", "영도구 부동산등기"],
    "영도·남항 일대 선박·어선·해운 관련 등기와 주택·상가 부동산등기·상속 수요가 있는 구입니다.",
    [],
    ["ship-registration", "inheritance-registration", "corporate-registration", "real-estate-registration"],
  ...
  district(
    ...
    "사하구",
    "region-saha-gu",
    ["사하구 법무사", "괴정동 법무사", "하단 법무사", "사하구 부동산등기"],
    "하단·괴정·당리 일대 주택·상가 상속·전세·매매 부동산등기 문의가 있는 구입니다.",
    [],
    ["inheritance-registration", "jeonse-registration", "real-estate-registration"],
    [INSTITUTION_IDS.namRegistry],
  ),
  district(
    "geumjeong-gu",
