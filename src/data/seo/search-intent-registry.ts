...
export const SEARCH_INTENT_REGISTRY: SearchIntent[] = [
  {
    ...
    notes: "INHERITANCE DECISION HUB — title frozen 2026-09-26",
  },
  {
    id: "inh-provider-selection",
    category: "inheritance",
    primaryIntent: "부산 상속전문 법무사 선택(업무범위·경험)",
    primaryKeyword: "부산 상속전문 법무사",
    aliases: ["부산상속전문법무사", "부산 상속 법무사 선택"],
    userProblem: "누구에게 맡길지, 업무범위·경험이 충분한지 비교",
    funnel: "provider-selection",
    currentUrl: "/부산상속전문법무사",
    existingCoverage: "strong",
    businessScope: "DIRECT",
    commercialScore: 18,
    urgencyScore: 10,
    ...
    finalOpportunityScore: 42,
    recommendedAction: "STRENGTHEN",
    notes: "PROVIDER SELECTION — indexable since 2026-09-26; not a procedure hub",
  },
  {
    id: "inh-reg",
    category: "inheritance",
