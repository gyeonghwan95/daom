...
export const ATTORNEY_PHOTOS: AttorneyPhoto[] = [
  ...
  {
    id: "document-review-wide",
    src: "/image/썸네일-서류확인.jpg",
    fileName: "썸네일-서류확인.jpg",
    orientation: "landscape",
    context: "document",
    peopleCount: 1,
    facePosition: "center",
    ...
    currentUsageUrls: [],
    privacyRisk: false,
    notes: "사무실에서 여러 서류를 펼쳐 검토하는 단독 사진. 상속 서류 주제에 적합.",
  },
  {
    id: "consultation-review",
    src: "/image/썸네일-상담협의.jpg",
    fileName: "썸네일-상담협의.jpg",
    orientation: "landscape",
    ...
    currentUsageUrls: [],
    privacyRisk: false,
    notes: "명패가 보이는 사무실에서 자료를 확인하는 단독 사진. 조회·상담 주제에 적합.",
  },
  {
    id: "registry-office-visit",
    src: "/image/썸네일-등기소.jpg",
    fileName: "썸네일-등기소.jpg",
    orientation: "landscape",
    context: "office",
    peopleCount: 1,
    facePosition: "right",
    ...
    currentUsageUrls: [],
    privacyRisk: false,
    notes: "부산지방법원 등기국 표지와 안윤정 법무사가 함께 보이는 현장 사진.",
  },
  {
    id: "contract-officer-review",
    src: "/image/썸네일-계약임원.jpg",
    fileName: "썸네일-계약임원.jpg",
    orientation: "landscape",
    context: "document",
    peopleCount: 1,
    facePosition: "right",
    ...
    currentUsageUrls: [],
    privacyRisk: false,
    notes: "계약·법인 관련 서류를 모니터 옆에서 검토하는 실제 업무 사진.",
  },
  {
    id: "desk-computer",
    src: "/image/썸네일-서류등기.jpg",
    fileName: "썸네일-서류등기.jpg",
    orientation: "landscape",
    context: "document",
    peopleCount: 1,
    facePosition: "right",
    ...
    currentUsageUrls: [],
    privacyRisk: false,
    notes: "사무실에서 등기 자료를 입력·검토하는 실제 업무 사진.",
  },
  {
    id: "consult-main",
    src: "/image/상담-메인.jpg",
    ...
    currentUsageUrls: [],
    privacyRisk: false,
    notes: "상담 중 설명하는 안윤정 법무사 단독 사진. 허브·상담 주제에 적합.",
  },
  {
    id: "office-phone",
    src: "/image/썸네일-사무실_전화중.jpg",
    fileName: "썸네일-사무실_전화중.jpg",
    orientation: "landscape",
    context: "consultation",
    peopleCount: 1,
    facePosition: "center",
    ...
    currentUsageUrls: [],
    privacyRisk: false,
    notes: "전화로 안내하면서 서류를 작성하는 안윤정 법무사 단독 사진.",
  },
  {
    id: "office-writing",
    src: "/image/썸네일-사무실.jpg",
    fileName: "썸네일-사무실.jpg",
    orientation: "landscape",
    context: "document",
    peopleCount: 1,
    facePosition: "center",
    ...
    currentUsageUrls: [],
    privacyRisk: false,
    notes: "사무실에서 등기 서류를 작성하는 안윤정 법무사 단독 사진.",
  },
  {
    id: "lecture-library",
