...
export const lectureKeywordUniverse: LectureKeywordRow[] = [
  ...
  // —— generic hiring (region-less) ——
  row("강사", "generic-hiring", "commercial", "/부산법률강사", "광범위. 법률·특강 맥락", "/법률강의"),
  row("강사 추천", "generic-hiring", "commercial", "/부산법률강사", "가짜 순위 없음"),
  row("강사 섭외", "generic-hiring", "commercial", "/부산법률강사", "지역 없음 → hiring"),
  row("강사 초빙", "generic-hiring", "commercial", "/부산법률강사", "동일"),
  row("외부강사", "generic-hiring", "commercial", "/부산법률강사", "동일"),
  row("외부강사 섭외", "generic-hiring", "commercial", "/부산법률강사", "동일"),
  row("전문강사", "generic-hiring", "commercial", "/부산법률강사", "동일"),
  row("전문강사 섭외", "generic-hiring", "commercial", "/부산법률강사", "동일"),
  row("전문가 특강", "generic-hiring", "commercial", "/부산법률강사", "동일", "/법률강의"),
  row("전문가 초청 특강", "generic-hiring", "commercial", "/부산법률강사", "동일"),
  row("특강 강사", "generic-hiring", "commercial", "/부산법률강사", "동일"),
  row("특강 강사 섭외", "generic-hiring", "commercial", "/부산법률강사", "동일"),
  row("강연 강사", "generic-hiring", "commercial", "/부산법률강사", "동일"),
  row("강연자 섭외", "generic-hiring", "commercial", "/부산법률강사", "동일"),
  row("연사 섭외", "generic-hiring", "commercial", "/부산법률강사", "동일"),
  row("초청 강사", "generic-hiring", "commercial", "/부산법률강사", "동일"),
  row("세미나 강사", "generic-hiring", "commercial", "/부산법률강사", "동일"),
  row("교육 강사", "generic-hiring", "commercial", "/부산법률강사", "법률교육 맥락"),
  row("법률 특강 강사", "generic-topic", "commercial", "/법률강의", "GENERIC pillar", "/부산법률강사"),
  row("진로 특강 강사", "career", "commercial", "/법무사진로특강", "GENERIC career"),
  row("법률교육 강사", "generic-topic", "commercial", "/법률강의", "동일", "/부산법률강사"),
  row("생활법률 특강 강사", "generic-topic", "commercial", "/법률강의", "동일", "/부산도서관법률특강"),
  ...
  row("현직자 강사", "career", "commercial", "/법무사진로특강", "직업인·현직자", "/학교법률교육"),
  row("현직자 특강", "career", "informational", "/법무사진로특강", "동일", "/학교법률교육"),
  row("현직자 초청 특강", "career", "informational", "/법무사진로특강", "동일"),
  row("직업인 특강", "career", "informational", "/법무사진로특강", "학교 공고형 표현", "/학교법률교육"),
  row("직업인 초청 특강", "career", "informational", "/법무사진로특강", "NEW_SCHOOL_TERM"),
  row("전문 직업인 특강", "career", "informational", "/법무사진로특강", "NEW_SCHOOL_TERM"),
  row("찾아가는 직업인 특강", "career", "informational", "/법무사진로특강", "NEW_SCHOOL_TERM"),
  row("진로특강 강사", "career", "commercial", "/법무사진로특강", "PRIMARY career"),
  row("진로교육 강사", "career", "commercial", "/법무사진로특강", "동일"),
  row("법조인 진로특강", "career", "informational", "/법무사진로특강", "PRIMARY"),
  row("법조인 초청 특강", "career", "informational", "/법무사진로특강", "동일"),
  row("현직 법조인 특강", "career", "informational", "/법무사진로특강", "동일"),
  row("법무사 직업특강", "career", "informational", "/법무사진로특강", "동일"),
  row("전문직 진로특강", "career", "informational", "/법무사진로특강", "동일"),
  row("고등학교 진로특강", "school", "informational", "/법무사진로특강", "진로 중심", "/학교법률교육"),
  row("고등학교 진로특강 강사", "school", "commercial", "/법무사진로특강", "PRIMARY school career"),
  row("고등학교 강사", "school", "commercial", "/학교법률교육", "학교 허브"),
  row("고등학교 외부강사", "school", "commercial", "/학교법률교육", "동일", "/부산법률강사"),
  row("학교 외부강사", "school", "commercial", "/학교법률교육", "동일"),
  row("대학교 특강 강사", "university", "commercial", "/학교법률교육", "대학 슬롯", "/청년생활법률특강"),
  row("대학 외부강사", "university", "commercial", "/학교법률교육", "동일"),
  row("대학생 진로특강", "university", "informational", "/법무사진로특강", "진로", "/청년생활법률특강"),
  row("대학생 현직자 특강", "university", "informational", "/법무사진로특강", "동일"),
  row("현직자 멘토링", "university", "informational", "/법무사진로특강", "NEW_UNIVERSITY_TERM"),
  row("비교과 특강 강사", "university", "commercial", "/학교법률교육", "NEW_UNIVERSITY_TERM"),
  row("취업 진로 특강", "university", "informational", "/법무사진로특강", "동일"),
  row("대학생 생활법률 특강", "university", "informational", "/청년생활법률특강", "생활법률", "/학교법률교육"),
  row("대학생 전세사기 예방교육", "university", "informational", "/전세사기예방교육", "주제"),
  ...
  row("공공기관 강사", "public", "commercial", "/공공기관법률교육", "지역 없음"),
  row("기관 외부강사", "public", "commercial", "/공공기관법률교육", "동일", "/부산법률강사"),
  row("기업교육 강사", "corporate", "commercial", "/기업법률교육", "지역 없음"),
  row("사내교육 강사", "corporate", "commercial", "/기업법률교육", "동일"),
  row("전세사기 예방 강사", "jeonse", "commercial", "/전세사기예방교육", "지역 없음"),
  row("창업 법률 강사", "startup", "commercial", "/창업법률교육", "지역 없음"),
  row("강사 프로필", "admin-docs", "informational", "/강사소개", "섭외 단계"),
  row("강의계획서", "admin-docs", "informational", "/부산강사섭외체크리스트", "동일"),
  row("특강 제안서", "admin-docs", "informational", "/부산강사섭외체크리스트", "동일"),
  row("강사료", "admin-cost", "informational", "/부산강사섭외비용", "고정가 없음"),
  row("외부강사 강사료", "admin-cost", "informational", "/부산강사섭외비용", "동일"),
  row("출강료", "admin-cost", "informational", "/부산강사섭외비용", "동일"),
  row("울산 법률강사", "region-adjacent", "commercial", "/부산법률강사", "출강 협의. clone 금지"),
  row("창원 청년특강 강사", "region-adjacent", "commercial", "/청년생활법률특강", "창원청년비전센터 이력"),
  row("양산 진로특강 강사", "region-adjacent", "commercial", "/법무사진로특강", "양산제일고 이력"),
  row("김해 법률특강", "region-adjacent", "informational", "/법률강의", "출강 협의 only"),
  row("경남 진로강사", "region-adjacent", "commercial", "/법무사진로특강", "실적 기반"),
