...
export const lectureIntentToUrlMap: LectureIntentMapEntry[] = [
  ...
  {
    id: "inquiry",
    intentLabel: "강의·특강·출강 문의",
    dimensions: ["부산", "강의 문의", "기관 담당자", "일정·제안"],
    primaryKeyword: "부산 강의 문의",
    secondaryKeywords: [
      "부산 특강 문의",
      "부산 강연 문의",
      "부산 출강 문의",
    ...
    targetUrl: "/강의문의",
    action: "strengthen",
    notes: "TRANSACTIONAL 전용. 섭외 검토는 /부산법률강사.",
  },
  {
