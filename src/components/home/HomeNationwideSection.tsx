...
const NATIONWIDE_HOME_CARDS = [
  {
    href: "/전국상속등기",
    title: "전국 상속등기",
    body: "부동산 소재지가 달라도 상담부터 신청까지 진행합니다.",
  },
  {
    href: "/전국유증등기",
    title: "전국 유증등기",
    body: "유언에 따른 이전 절차를 비대면으로 끝까지 진행합니다.",
  },
  {
    href: "/여러지역상속부동산등기",
    title: "여러 지역 상속부동산",
    body: "흩어진 부동산을 한 곳에서 목록·일정까지 진행합니다.",
  },
  {
    href: "/전국법인본점이전등기",
    title: "전국 법인 본점이전",
  ...
  },
  {
    href: "/전국업무",
    title: "전국 업무 전체 보기",
    body: "관할 특례·비대면 진행 업무를 한눈에 보고 바로 문의하세요.",
  },
] as const;
  ...
  return (
    ...
    >
      ...
      <p className="mt-3 max-w-3xl text-base leading-relaxed text-navy/75">
        상속·유증등기, 타지역 법인 본점이전, 여러 지역 부동산 공동담보 등은
        부산에 오지 않아도 상담부터 신청까지 원활히 진행할 수 있습니다.
        전화·카카오톡·우편으로 바로 시작해 보세요.
      </p>
