...
import { ContentThumbnailCard } from "./ContentThumbnailCard";

export type RelatedContentCarouselProps = {
  heading: string;
  description?: string;
...
/**
 * 관련 콘텐츠 캐러셀 — CSS scroll-snap, autoplay 없음, crawlable <a>.
 */
export function RelatedContentCarousel({
  ...
  const headingId = `related-carousel-${heading.replace(/\s+/g, "-").slice(0, 40)}`;

  return (
    <section
      aria-labelledby={headingId}
      data-related-content="carousel"
