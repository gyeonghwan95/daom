...
export const serviceDetails: ServiceDetail[] = [
  {
    ...
    title: "상속등기",
    description:
      "전국·부산 상속등기 — 다옴법무사사무소 안윤정 법무사가 타지역 부동산도 관할 특례를 검토하며 상담합니다. 상속인 확인, 서류 안내, 등기 신청까지.",
    intro:
      "피상속인이 돌아가신 뒤, 남은 부동산이나 토지를 상속인 명의로 바꾸는 절차가 상속등기입니다. 등기를 마치지 않으면 매매·담보 설정 등이 어려울 수 있고, 상속포기·한정승인 검토 기간과 취득세 신고기한은 별도로 확인해야 합니다. 다옴법무사사무소 안윤정 법무사는 부산뿐 아니라 전국 소재 상속부동산도 관할 특례 적용 여부를 확인하며 상담부터 등기 완료까지 함께 진행합니다.",
    whenNeeded:
      "부모님이나 배우자의 사망 후 명의가 피상속인으로 남아 있는 아파트, 주택, 토지, 상가가 있을 때 상속등기가 필요합니다. 상속인이 여러 명이면 협의서 작성이 필요하고, 망소(사망) 전에 이미 증여·매매 등이 있었다면 등기부를 먼저 확인해야 합니다. 해운대·센텀·재송동 등 부산 지역뿐 아니라 타지역 부동산 상속도 상담합니다.",
    procedures: [
      "상담 및 등기부·가족관계 확인 — 상속인 수, 부동산 현황, 채무 여부를 파악합니다.",
      "상속포기·한정승인 필요 여부 점검 — 3개월 검토 기간과 상속등기 일정을 구분해 안내합니다.",
      "필요 서류 안내 및 수집 — 제적·가족관계증명서, 인감증명서, 토지·건축물 대장 등을 준비합니다.",
      "상속인 협의 — 공동상속인이 있으면 협의서·분할협의서 등을 정리합니다.",
      "등기 신청서 작성 및 등기소 접수 — 관할 특례 적용 여부를 확인한 뒤 신청 등기소를 안내합니다.",
    ...
    commonIssues: [
      ...
      "상속포기·한정승인 검토 기간(3개월)과 상속등기·취득세 일정을 혼동하는 경우",
      "형제자매 간 상속분 분쟁으로 등기가 늦어지는 경우",
      "상속 채무가 예상보다 많아 상속포기·한정승인을 함께 검토해야 하는 경우",
      "여러 지역에 상속부동산이 흩어져 목록 정리가 필요한 경우",
    ],
    ourApproach:
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "상담·진행을 검토할 수 있습니다. 상속·유증등기는 법에서 정한 관할 특례가 적용될 수 있어 부동산 소재지 관할이 아닌 등기소를 통한 신청도 가능한지 확인합니다. 구체적인 신청 방식과 특례 적용 여부는 부동산 수·등기원인·사건 구조를 확인한 뒤 안내합니다.",
      },
      {
        question: "상속등기 비용은 어떻게 되나요?",
        answer:
          "부동산 가액, 상속인 수, 채권·채무 정리 여부에 따라 달라집니다. 상담 시 법무사 보수와 취득세·등기신청수수료 등 공과금을 구분해 안내합니다. 서류 확인 전 확정 비용을 단정하지 않습니다.",
      },
    ],
    relatedCase: {
