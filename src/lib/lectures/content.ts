...
const hub: LecturePageContent = {
  ...
  faqs: [
    ...
    {
      question: "워크숍과 워크샵은 다른 강의인가요?",
      answer:
        "같은 형식입니다. 철자만 다를 뿐 별도 페이지를 두지 않습니다. 사례 질문·체크리스트·질의응답 중심의 참여형으로 협의할 수 있으며, 게임형 퍼실리테이션은 제공하지 않습니다.",
    },
    {
      question: "세미나·특강·강연을 각각 다른 프로그램으로 준비해야 하나요?",
      answer:
        "검색어는 달라도 한 회차 출강으로 구성하는 경우가 많습니다. 정보전달 비중(세미나)과 참여 비중(워크숍)만 시간에 맞춰 조정합니다.",
    },
    {
      question: "기업 워크숍에서 생활법률 특강을 할 수 있나요?",
      answer:
        "가능합니다. 임직원·신입 대상 계약·생활법률 모듈은 기업 법률교육 안내를 보신 뒤 강의 문의해 주세요.",
    },
  ],
...
const hiring: LecturePageContent = {
  ...
  faqs: [
    ...
    {
      question: "부산 워크숍·워크샵 강사 문의도 여기인가요?",
      answer:
        "맞습니다. 워크숍과 워크샵은 같은 형식으로 보고, 별도 URL을 만들지 않습니다. 사례·체크리스트 비중을 원하시면 문의에 ‘워크숍’이라고만 적어 주세요.",
    },
    {
      question: "세미나·초청강연과 특강은 어떻게 다른가요?",
      answer:
        "세미나는 정보전달·주제 설명 비중이 큰 한 회차 출강으로 구성할 수 있습니다. 특강·강연·초청강사도 같은 출강 문의로 받으며, 시간(60~120분)과 Q&A만 맞춰 드립니다.",
    },
    {
      question: "강사 섭외를 위해 어떤 정보를 보내면 되나요?",
      answer:
        "기관·기업명, 교육 대상, 예상 인원, 희망일·시간, 행사 형태(특강·워크숍·세미나·직원교육), 주제만 있어도 됩니다. 민감자료는 초기 문의에 보내지 않아도 됩니다.",
    },
  ],
  relatedLectureLinks: [
...
const enterprise: LecturePageContent = {
  ...
  faqs: [
    ...
    {
      question: "기업 워크숍·사내특강도 가능한가요?",
      answer:
        "가능합니다. 특강·워크숍(워크샵)·세미나 모두 같은 출강 문의로 협의합니다. 리더십·마케팅 강의는 다루지 않습니다.",
    },
    {
      question: "임직원 특강과 신입사원 교육은 내용이 다른가요?",
      answer:
        "신입은 60분 생활·계약 기초, 임직원·관리자는 미수금·증거·등기기한 비중을 높일 수 있습니다. 직급이 섞이면 공통 안내와 질답으로 나눕니다.",
    },
    {
      question: "직원 전세사기 예방교육을 사내에 넣을 수 있나요?",
      answer:
        "복리후생·생활안전 프로그램으로 전세사기 예방 모듈을 넣을 수 있습니다. 상세는 전세사기 예방교육 안내를 참고해 주세요.",
    },
  ],
  relatedLectureLinks: [
...
const speaker: LecturePageContent = {
  ...
  metaDescription:
    "안윤정 법무사 강사 소개. 부산 법률 강의·특강 출강. 법무사·공인중개사·신용관리사·직업상담사, 교사 자격, 부산대 행정대학원 재학. 생활법률·전세사기 예방·청년·진로 특강.",
  h1: "기관이 먼저 찾는 부산 법률 강사, 안윤정 법무사",
  eyebrow: "확인된 출강 · 기관용 강사 프로필",
  heroIntro:
    "도서관·청년기관·학교·공공 협업까지, 현장에서 검증된 생활법률 특강. 법무사 실무와 교육 경험을 바탕으로 대상·시간에 맞춰 바로 쓸 수 있는 강의로 구성합니다.",
  heroParagraphs: [
    "상속·부동산·법인·회생 사건을 다루며, 시민도서관·자립지원기관·청년공간·고등학교 등에서 출강해 왔습니다.",
    "용어 나열이 아니라, 계약·등기부·분쟁 예방처럼 현장에서 바로 확인하는 포인트를 중심으로 설명합니다.",
  ],
  summaryItems: [
