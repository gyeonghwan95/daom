...
const hub: LecturePageContent = {
  ...
  eyebrow: "강의·특강 안내",
  heroIntro:
    "법률·진로·생활법률 특강 강사를 찾는 학교·대학·기관·기업 담당자를 위한 출강 안내입니다. 안윤정 법무사가 현직 법무사로서 부산 중심으로 출강하며, 지역명을 넣지 않고 검색한 경우에도 대상·주제·이력을 먼저 고를 수 있습니다.",
  heroParagraphs: [
    "법정 지정교육(청렴·성희롱예방·산업안전 등)은 안내 범위에 넣지 않습니다. 마케팅·리더십·AI처럼 법무사 업무와 무관한 강의도 다루지 않습니다. 부산·인근·온라인 일정은 협의합니다.",
  ],
  bodySections: [
    {
      ...
      paragraphs: [
        ...
        "‘강사 섭외·외부강사·특강 강사’처럼 지역 없이 비교 중이라면 섭외 기준 페이지로, 부산에서 출강 가능한지를 보려면 부산 강사 초빙 안내로 이어집니다. 출강 사실은 강의 이력, 일정·제안은 강의 문의로 연결합니다.",
      ],
    },
    {
      title: "지역명을 넣지 않고 검색한 경우",
      paragraphs: [
        "법률 특강 강사·진로 특강 강사·외부강사처럼 지역 없이 검색해도, 이 허브에서 대상(학교·대학·기관·기업·청년)과 주제(생활법률·전세·창업·진로)를 먼저 고르면 됩니다.",
        "부산 소재·부산 출강 이력이 결정 기준이면 ‘부산 강사 초빙’ 페이지에서 로컬 실적과 섭외 체크리스트를 이어서 확인하세요. 지역명만 바꾼 복제 페이지는 만들지 않습니다.",
      ],
    },
  ],
  summaryItems: [
...
const hiring: LecturePageContent = {
  slug: "부산법률강사",
  kind: "hiring",
  title: "부산 강사·특강·강연 출강",
  metaTitle: "부산 강사 초빙｜기관·기업·청년 대상 특강·강연",
  metaDescription:
    "부산에서 기관·기업·청년·시민 교육용 외부강사·특강·강연을 찾을 때, 안윤정 법무사의 확인된 출강 이력·대상별 주제·시간 구성·준비 절차를 안내합니다. 법정의무교육은 범위에 넣지 않습니다.",
  h1: "부산에서 특강·강연 강사를 찾고 계신가요?",
  eyebrow: "부산 강사 · 특강 · 강연",
  heroIntro:
    "부산에서 외부 강사를 찾는 기관 담당자라면 강사의 직함보다 먼저 ‘우리 교육대상에게 실제로 필요한 이야기를 할 수 있는가’를 확인하게 됩니다. 청년에게는 주거·계약·금전거래가, 창업자에게는 계약·법인·미수금이, 시민에게는 상속·전세·생활분쟁이 더 직접적인 주제가 될 수 있습니다.",
  heroParagraphs: [
    "이 페이지는 부산 강사·특강·강연 검색으로 들어오신 담당자가 출강 가능 여부, 대상별 주제, 확인된 이력, 60분·90~120분·3~4시간 구성을 한곳에서 점검하도록 정리했습니다. 리더십·마케팅·재테크·심리·세무·노무처럼 법무사 업무 밖 주제와 법정 지정교육은 다루지 않으며, 확인되지 않은 출강 횟수나 만족도는 적지 않습니다.",
  ],
  ...
  faqs: [
    {
      question: "부산 강사·특강·강연 검색으로 왔는데 법률 강의만 가능한가요?",
      answer:
        "안윤정 법무사가 직접 출강하는 범위는 생활법률·주거·계약·전세사기 예방·창업·법인 기초·진로 등 법무사 실무와 연결된 주제입니다. 리더십·마케팅·재테크·심리·세무·노무·법정 지정교육은 안내하지 않습니다.",
    },
    {
  ...
  ctaTitle: "출강·특강 구성을 문의하세요",
  ctaText:
    "기관명·교육대상·희망일·시간·주제를 알려주시면 출강 가능 여부와 강의구성 확인에 필요한 사항을 안내합니다.",
  disclaimer: commonDisclaimer,
  showInquiryForm: true,
  showPrintProfile: true,
  showFormatGuide: true,
  showTopicFinder: false,
  primaryKeywords: ["부산 강사", "부산 특강", "부산 강연"],
  secondaryKeywords: [
    "부산 강사 초빙",
    "부산 강사 출강",
    "부산 외부강사",
...
const school: LecturePageContent = {
  ...
  heroIntro:
    "고등학교 직업인 초청·진로특강, 대학교 비교과·현직자 특강, 생활법률 교양 특강까지—담당자가 고른 목적에 맞춰 구성을 나눕니다.",
  heroParagraphs: [
    "확인된 학교 출강은 양산제일고 법무사 진로특강입니다. 부산·인근 학교·대학 일정은 학년·시수·장소(강당·교실)에 맞춰 협의합니다. 확인되지 않은 학교명을 나열하지 않습니다.",
  ],
  bodySections: [
    {
      title: "고등학교: 직업인·진로특강이 먼저인 경우",
      paragraphs: [
        "진로부장·담임이 ‘직업인 초청 특강’, ‘현직자 특강’, ‘법조인 진로특강’으로 찾을 때는 법률 지식을 암기시키는 강의보다 직업을 이해시키는 구성이 맞습니다. 법무사가 하는 일·시험·현장의 보람과 한계를 학생 언어로 설명합니다.",
        "진로만 필요하면 법무사 진로특강 페이지 구성으로 단독 진행합니다. 생활법률(계약·온라인·금전)을 함께 넣을지는 시수에 맞춰 사전 조율합니다.",
      ],
    },
    {
      title: "대학교: 진로·비교과·생활법률을 나누는 기준",
      paragraphs: [
        "대학 담당자가 비교과·현직자 멘토링·취업 진로 특강을 원할 때는 진로 모듈을, 자취·전월세·금전거래·창업 기초가 목적이면 청년 생활법률·전세사기 예방·창업 법률교육 페이지와 주제를 나눕니다.",
        "강의계획서·강사 프로필이 필요하면 섭외 체크리스트와 강사 소개를 함께 보시면 됩니다. 학교폭력 전문상담이나 수사 절차를 대체하지 않습니다.",
      ],
    },
    {
      ...
      paragraphs: [
        ...
        "50분 수업시수와 60~90분 특강 슬롯에 맞춰 일과 소개·사례·질의응답 비중을 조절합니다.",
      ],
    },
  ],
  summaryItems: [
  ...
  faqs: [
    {
      question: "직업인 초청·현직자 특강만 가능한가요?",
      answer:
        "가능합니다. 진로·직업 이해 중심이면 법무사 진로특강 구성으로 단독 진행합니다.",
    },
    {
    ...
    {
      question: "대학 비교과·멘토링 형식도?",
      answer:
        "비교과·현직자 멘토링 슬롯에 맞춰 진로 또는 생활법률 비중을 조정합니다.",
    },
    {
      question: "학부모 대상도?",
  ...
  relatedLectureLinks: [
    ...
    { href: "/청년생활법률특강", label: "청년·대학생 생활법률" },
    { href: "/전세사기예방교육", label: "전세사기 예방교육" },
    { href: "/디지털법률교육", label: "디지털 법률교육" },
    { href: "/법률강의", label: "강의·특강 안내" },
    { href: "/강의이력", label: "강의 이력" },
  ...
  ctaText: "학년·인원·희망 주제(진로/생활법률)만 남겨 주세요.",
  disclaimer: commonDisclaimer,
  showInquiryForm: true,
...
const career: LecturePageContent = {
  ...
  eyebrow: "진로·직업 특강",
  heroIntro:
    "고등학교·대학교에서 직업인·현직자·법조인 진로특강 강사를 찾을 때, 현직 법무사가 실제 일과 준비를 학생 언어로 설명합니다.",
  heroParagraphs: [
    "양산제일고등학교 진로특강 이력이 있습니다. 합격 신화·성공 보장을 말하지 않고, 현실적인 일과 준비를 설명합니다. ‘최고의 강사’처럼 표현하지 않습니다.",
  ],
  bodySections: [
    {
      title: "직업인·현직자 초청 특강으로 요청될 때",
      paragraphs: [
        "학교가 ‘전문 직업인 특강’, ‘찾아가는 직업인 특강’, ‘현직자 초청 특강’으로 공고해도, 이 구성의 중심은 법률 암기가 아니라 법무사라는 직업을 이해하는 것입니다.",
        "하루 업무·필요한 역량·시험·관련 자격(공인중개사 등)의 시너지·현장의 보람과 어려움을 학생 질문에 맞춰 나눕니다. 법무 사건 수임 홍보 페이지로 쓰지 않습니다.",
      ],
    },
    {
      ...
      paragraphs: [
        ...
        "양산제일고에서 진행한 진로특강을 기준으로, 50분 수업시수와 60~90분 특강 슬롯에 맞춰 일과 소개·자격 이야기·질의응답 비중을 조절합니다.",
      ],
    },
    {
      ...
      paragraphs: [
        ...
        "교사가 미리 받고 싶은 소개 자료는 강사 소개·섭외 체크리스트와 강의 이력의 해당 출강 기록을 함께 보시면 됩니다.",
      ],
    },
  ],
  summaryItems: [
  ...
  faqs: [
    {
      question: "직업인 초청·현직자 특강 공고에도 맞나요?",
      answer:
        "맞습니다. 법무사 직업 이해·현직자 특강 구성으로 진행하며, 법률 암기 강의가 아닙니다.",
    },
    {
    ...
    {
      question: "강사 소개 자료는?",
      answer: "강사 소개·섭외 체크리스트 페이지를 활용해 주세요.",
    },
    {
    ...
    {
      question: "비용은?",
      answer: "시간·이동·교안 범위에 따라 협의합니다. 허위 정액표는 제시하지 않습니다.",
    },
  ],
  relatedLectureLinks: [
    { href: "/학교법률교육", label: "학교 법률교육" },
