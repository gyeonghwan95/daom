...
export const counselPages: CounselPageContent[] = [
  {
    slug: "부산법률상담",
    title: "부산 법률 자문·상담 — 업무와 전문가 구분",
    metaTitle:
      "부산 법률 자문을 찾을 때｜문제에 맞는 절차와 전문가 구분",
    metaDescription:
      "부산에서 법률 자문·상담이 필요할 때 등기·상속·법인·임대차·법원서류처럼 법무사 업무인지, 소송·세무·노무처럼 다른 전문가가 필요한지 먼저 구분하는 안내입니다.",
    h1: "부산에서 법률 자문이 필요할 때 먼저 확인할 업무",
    eyebrow: "법률 자문 · 상담 입구 안내",
    heroIntro:
      "업무명을 정확히 모르셔도 현재 상황을 설명하면 법무사 업무에 해당하는지부터 확인합니다.",
    heroParagraphs: [
      "부산에서 법률 자문·법률상담을 검색할 때는 ‘어떤 문제도 한곳에서 해결한다’는 약속보다, 지금 필요한 것이 상담인지·등기인지·법원 서류인지·소송인지부터 나누는 편이 빠릅니다. 이 페이지는 입구를 찾는 안내이며 포괄적 법률의견을 대체하지 않습니다.",
      "부동산·등기, 상속등기·상속포기·한정승인, 법인설립·변경등기, 지급명령 등 법원 제출서류는 법무사 업무범위에서 검토할 수 있습니다. 소송대리·복잡한 법률분쟁은 변호사, 세무는 세무사, 노무는 노무사 등 다른 전문가가 맞을 수 있습니다.",
    ...
    faqs: [
      {
        question: "부산 법률 자문과 법률상담은 같은 의미인가요?",
        answer:
          "검색어는 달라도 ‘내 문제가 어떤 절차·전문가에게 해당하는지’를 확인하려는 경우가 많습니다. 이 페이지는 등기·상속·법인·법원서류처럼 법무사 업무인지, 소송·세무·노무처럼 다른 영역인지부터 구분합니다. 포괄적 법률의견을 대신하지 않습니다.",
      },
      {
    ...
    ctaTitle: "어떤 업무인지 먼저 확인하세요",
    ctaText:
      "업무명을 정확히 모르셔도 현재 상황을 알려주시면 법무사 업무인지와 먼저 확인할 자료부터 안내합니다.",
  },
];
