...
export const counselPages: CounselPageContent[] = [
  {
    ...
    metaTitle:
      "부산 법률상담을 찾는다면｜법무사가 지원하는 등기·서류·절차 안내",
    metaDescription:
      "부산에서 법률상담이 필요한 상황을 상속, 부동산등기, 법인등기, 개인회생·개인파산, 지급명령·내용증명, 임차권등기 등 절차별로 안내합니다. 다옴법무사사무소 안윤정 법무사의 지원 가능 업무와 별도 검토가 필요한 사안을 구분해 확인할 수 있습니다.",
    h1: "부산 법률상담 전, 필요한 절차부터 확인하세요",
    eyebrow: "다옴법무사사무소 · 안윤정 법무사",
    heroIntro:
      "부산에서 법률절차가 막막할 때, 법무사가 지원할 수 있는 등기·서류·신청 절차부터 확인하세요.",
    heroParagraphs: [
      "다옴법무사사무소 안윤정 법무사가 등기, 공탁, 법원 제출서류 작성, 상속·회생파산 등 법무사가 수행할 수 있는 절차를 안내합니다.",
      "‘법률상담’이라는 검색어는 넓게 쓰이지만, 이 페이지는 변호사 사무실을 대체하거나 모든 법률문제를 처리한다고 안내하지 않습니다. 지원 가능한 업무와 별도 검토가 필요한 사안을 구분합니다.",
    ],
    ...
    relatedLinks: [
      ...
      { href: "/부산기업법률자문", label: "부산 기업 법률실무" },
    ...
    ctaTitle: "필요한 업무를 확인하셨나요?",
    ctaText:
      "상황과 기한만 남겨 주시면, 다옴법무사사무소 안윤정 법무사가 지원 가능 업무를 안내합니다.",
  },
];
