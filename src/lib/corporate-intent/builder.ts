...
export function buildCorporateIntentPage(
  ...
  return {
    ...
    jurisdictionGuide: {
      title: "관할·업무 범위",
      jurisdictionNote:
        "법인 본점 소재지 관할 등기소 기준으로 접수하며, 부산 해운대·센텀 다옴법무사사무소에서 상담·수임을 진행합니다.",
      practicalNotes: [
