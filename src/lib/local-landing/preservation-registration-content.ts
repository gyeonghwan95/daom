...
export const preservationRegistrationContent: PreservationRegistrationContent = {
  ...
  busanConsultParagraphs: [
    ...
    "센텀·문현·재송 일대 오피스·근린생활시설, 서면·전포·부전 상가 신축, 강서구·녹산·명지 산업·물류 시설처럼 용도가 다양한 경우가 있습니다. 관할은 등기국·동부지원 등기과·남부산등기소·서부지원 등기과·북부산등기소로 나뉘므로 소재지 확인이 우선입니다.",
  ...
  internalLinks: [
    ...
    { href: "/토지소유자와건축주다른보존등기", label: "토지·건축주가 다른 보존등기" },
    { href: "/건축주법인신축보존등기", label: "건축주가 법인인 보존등기" },
    { href: "/보존등기후근저당설정", label: "보존등기 후 근저당" },
