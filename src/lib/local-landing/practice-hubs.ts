...
> = {
  등기실무: {
    ...
    cards: [
      ...
      { href: "/부산증여등기", title: "증여등기 허브", description: "부모·부부·부담부·지분" },
      { href: "/부산부모자녀아파트증여등기", title: "부모자녀 아파트 증여", description: "관계·서류 확인" },
      { href: "/부산부부간증여등기", title: "부부간 증여등기", description: "공동명의·지분" },
      { href: "/부산부담부증여등기", title: "부담부증여 등기", description: "대출·전세 있는 이전" },
      { href: "/부산공동명의지분증여등기", title: "지분 증여등기", description: "일부 지분 이전" },
      { href: "/부산명의변경등기", title: "명의변경등기", description: "원인별 명의 이전 안내" },
      { href: "/부산가등기", title: "가등기 설정·말소", description: "청구권·담보가등기" },
      { href: "/부동산실권리자명의등기", title: "실권리자명의등기", description: "명의신탁 해소" },
      { href: "/부산경매권리분석", title: "경매 권리분석", description: "입찰 전 등기부 확인" },
