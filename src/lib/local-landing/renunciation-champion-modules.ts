...
export const renunciationChampionExtraWhenNeeded: string[] = [
  ...
  "배우자·자녀 중 일부만 포기할지, 전원 포기할지 효과가 달라 확인이 필요한 경우",
...
export const renunciationChampionExtraFaqs: ServiceFaq[] = [
  ...
  },
  {
    ...
    answer:
      "본인의 상속분만 정리되는 것이고, 남은 공동상속인에게는 효과가 이어집니다. 배우자·자녀가 함께 상속인인 상태에서 자녀만 전부 포기하면 배우자가 단독상속인이 되는 경우가 있어, ‘다음 순위 부모·형제에게 바로 넘어간다’고 단정하지 않습니다. 배우자와 자녀가 모두 포기하면 그다음 순위를 확인합니다.",
  },
  {
