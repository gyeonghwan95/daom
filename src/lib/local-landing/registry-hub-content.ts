...
export const registryHubHeroParagraphs = [
  "부산에서 등기 법무사를 찾고 있다면 먼저 어떤 등기가 필요한지 확인해야 합니다. 아파트 매매·증여·상속에 따른 소유권이전부터 근저당 설정·말소, 법인설립·임원변경까지 사건에 따라 준비서류와 접수 순서가 달라집니다. 다옴법무사사무소에서는 등기부와 관련 서류를 확인해 필요한 절차부터 안내합니다.",
  "정확한 등기명을 몰라도 됩니다. 등기부·계약서 또는 지금 상황만 알려 주시면, 해운대·센텀 다옴법무사사무소 안윤정 법무사가 필요한 등기와 준비서류를 구분합니다.",
];
