...
export const registryHubHeroParagraphs = [
  "부산에서 등기전문 법무사를 찾을 때도 먼저 확인할 것은 ‘어떤 등기부를 바꾸려는지’입니다. 부동산 소유권이전·증여·근저당·전세권·보존·멸실, 상속등기, 법인설립·임원변경·본점이전·유상증자, 공익사업 과정의 보상등기는 서류와 접수 순서가 다릅니다.",
  "정확한 등기명을 몰라도 됩니다. 등기부·계약서 또는 지금 상황만 알려 주시면, 해운대·센텀 다옴법무사사무소 안윤정 법무사가 필요한 등기와 준비서류를 구분합니다. 아래 상황별 안내에서 부동산·상속·법인·보상 갈래로 이동하세요.",
];
...
export const registryHubSituations: RegistryHubSituation[] = [
  ...
  {
    title: "공익사업·협의취득·수용 관련 등기가 있습니다",
    links: [
      { href: "/부산보상등기", label: "공익사업·협의취득 과정의 보상등기" },
...
export const registryHubWorkAreas: RegistryHubWorkArea[] = [
  ...
  {
    title: "법인등기",
    items: ["법인설립", "임원변경", "본점이전", "목적변경", "유상증자", "해산·청산"],
    links: [
      { href: "/부산법인등기", label: "부산 법인등기" },
      { href: "/부산법인설립등기", label: "법인설립등기" },
      { href: "/부산임원변경등기", label: "임원변경등기" },
      { href: "/부산유상증자등기", label: "유상증자등기" },
    ],
  },
  {
    title: "보상·공공 관련 등기",
    items: ["협의취득", "수용", "촉탁등기", "권리관계 정리"],
    links: [
      { href: "/부산보상등기", label: "부산 보상등기" },
      { href: "/공공기관등기업무", label: "공공기관 등기업무" },
      { href: "/촉탁등기", label: "촉탁등기" },
    ],
  },
...
export const registryHubFaqs: ServiceFaq[] = [
  {
    question: "부산에서 등기전문 법무사를 찾을 때 업무부터 구분해야 하는 이유는?",
    answer:
      "부동산·상속·법인·보상 등기는 등기부와 원인 서류가 다릅니다. ‘등기전문’이라는 검색어만으로 상담을 시작하면 분류가 빠질 수 있어, 지금 바꾸려는 등기부부터 고르는 것이 안전합니다.",
  },
  {
    question: "부산 등기 법무사에게 어떤 업무를 맡길 수 있나요?",
    answer:
      "부동산 소유권이전·증여·근저당·전세권·보존·멸실, 상속등기, 법인설립·임원변경·본점이전·유상증자, 공익사업 과정의 보상등기 상담·진행을 안내합니다. 정확한 등기명을 몰라도 등기부나 현재 상황만 알려 주시면 됩니다.",
  },
  {
  ...
  {
    question: "보상등기와 일반 매매등기는 어떻게 다른가요?",
    answer:
      "공익사업·협의취득·수용 과정의 보상등기는 사업시행자·촉탁·권리관계 정리가 중심입니다. 일반 매매와 원인서류·신청 구조가 다를 수 있어 보상등기 안내에서 따로 확인합니다.",
  },
  {
...
export const registryHubTopic: KeywordTopic = {
  ...
  metaDescription:
    "부산에서 소유권이전·상속·증여·근저당·법인·보상등기를 준비한다면 필요한 서류와 절차를 확인해 보세요. 해운대·센텀 다옴법무사사무소 안윤정 법무사가 등기업무를 직접 상담·진행합니다.",
  h1: "부산 등기 법무사, 어떤 등기부터 준비해야 할까요?",
  serviceSlug: "real-estate-registration",
  primaryKeywords: ["부산 등기 법무사", "부산 등기전문 법무사", "부산 등기업무"],
  summaryParagraphs: registryHubHeroParagraphs,
  problemStatement:
    "부산에서 등기전문 법무사를 검색할 때 확인할 업무 범위는 부동산·상속·법인·보상으로 갈립니다. 아파트 매매 잔금일 소유권이전, 부모님 부동산 상속, 가족 간 증여, 대출에 따른 근저당 설정·말소, 회사 설립·임원변경·유상증자, 신축 보존·멸실, 공익사업 협의취득·수용 과정의 보상등기처럼 사건이 다릅니다. 이 페이지는 어떤 등기를 찾아야 하는지 결정하는 허브이며, 세부 절차는 각 안내로 이어집니다.",
  whenNeeded: [
