...
export function buildBusanLawyerFlagshipPage(
  ...
  return {
    ...
    problemStatement:
      "부산에서 법무사를 찾는 이유는 사람마다 다릅니다. 부모님 사망 후 부동산·채무 정리, 아파트 매매 잔금 후 소유권이전, 법인 설립·임원변경, 카드·대출 누적에 따른 개인회생처럼 사건이 갈립니다. 이 페이지에서는 필요한 절차를 가린 뒤 상속·등기·법인·회생 안내로 이어집니다. 사무소·대표 안내는 다옴법무사사무소 홈에서 확인하시면 됩니다. 관할은 부동산·법인 본점 소재지에 따라 등기국·동부지원 등기과·남부산등기소·서부지원 등기과·북부산등기소와 부산가정법원·부산회생법원으로 나뉩니다. 처음 확인할 사실은 업무명이 아니라 지금 놓치면 안 되는 기한입니다.",
    whenNeeded: [
    ...
    jurisdictionGuide: {
      ...
      accessNote:
        "부동산 소재지·법인 본점에 따라 등기국·동부지원 등기과·남부산등기소·서부지원 등기과·북부산등기소로 나뉩니다. 상속포기·한정승인은 부산가정법원, 개인회생은 부산회생법원 관할을 확인하세요.",
      jurisdictionNote:
