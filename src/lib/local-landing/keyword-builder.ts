  ...
  return {
    ...
    extraPageSections: isInheritanceChampion
      ? [
          {
            title: "상황별로 먼저 볼 절차",
            body: "이 페이지는 무엇을 고를지 정하는 허브입니다. 상속포기 기한·가족관계 상세는 부산 상속포기 안내에서, 한정승인은 한정승인 안내에서 이어집니다.",
            items: [
              "부동산만 있고 채무 걱정이 거의 없음 → 상속등기",
              "채무가 많아 상속을 받지 않으려 함 → 상속포기",
              "재산은 남기고 채무만 제한하고 싶음 → 한정승인",
