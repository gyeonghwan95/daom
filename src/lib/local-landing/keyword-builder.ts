  ...
  return {
    ...
    extraPageSections: isInheritanceChampion
      ? [
          {
            title: "지금 어떤 상황인가요?",
            body: "가까운 항목을 고르면 다음 안내가 갈립니다. 상세 절차는 각 페이지에서 이어집니다.",
            items: [
              "재산을 받음 → 상속등기",
              "빚이 걱정 → 상속포기 / 한정승인",
              "재산·채무를 모름 → 조회 후 승인 방식",
              "3개월 경과·임박 → 포기·한정·특별한정 확인",
              "복잡한 가족관계 → 미성년 / 해외 / 연락두절 / 대습",
            ],
            links: [
          ...
          },
          {
            ...
            body: "등기 서류보다 아래 세 가지를 먼저 맞춥니다.",
            items: [
              "사망일·인지일 — 포기·한정 3개월 기산",
              "상속인 구성 — 배우자·자녀·대습",
              "재산 vs 채무 — 등기인지 승인 방식인지",
            ],
            links: [
          ...
          {
            title: "상속등기·상속포기·한정승인의 차이",
            body: "목적·관할·기한이 다릅니다. 이 페이지에서는 갈래만 가른 뒤 각 안내로 보냅니다.",
            items: [
              "상속등기 — 등기소 명의이전",
              "상속포기 — 가정법원. 상속 자체를 받지 않음",
              "한정승인 — 가정법원. 재산 한도로만 채무 부담",
            ],
            links: [
              { href: "/부산상속등기", label: "상속등기 상세" },
              { href: "/부산상속포기", label: "상속포기 상세" },
              { href: "/부산한정승인", label: "한정승인 상세" },
            ],
          },
          {
            title: "가족관계가 복잡한 경우",
            body: "미성년·해외·연락두절·대습은 준비와 일정이 달라질 수 있습니다. 상세는 각 안내로 연결합니다.",
            items: [
              "미성년 — 특별대리 검토",
              "해외 — 위임·인증",
              "연락두절 — 등기·승인 전 확인",
          ...
          {
            title: "진행에 필요한 기본정보와 비용 변수",
            body: `상담 전에는 사망일·상속인·부동산·채무 여부만 있으면 됩니다. 수임료는 상속인·부동산·포기·한정 병행·해외·미성년에 따라 달라지며 등록면허세·취득세·법원 수수료는 별도입니다. 사무소: ${officeLocation.fullAddress}.`,
            items: [
              "최소 정보: 사망일·가족관계·재산·채무",
              "비용 변수: 상속인 수·부동산 수·병행 절차·해외·미성년",
            ],
          },
        ]
      : isRegistryHub
