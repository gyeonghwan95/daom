...
export const expansionLandingConfigs: LocalLandingConfig[] = [
  ...
  { slug: "동래구법무사", pageType: "region-hub", serviceSlug: "inheritance-registration", regionKey: "dongnae", regionLabel: "동래구", neighborhoods: ["온천동", "사직동", "명륜동"], caseAngle: "동래구 단독주택·재건축 상속", linkedNeighborhoodSlugs: ["동래역법무사", "사직동법무사", "안락동법무사", "온천동법무사"] },
  { slug: "부산진구법무사", pageType: "region-hub", serviceSlug: "real-estate-registration", regionKey: "busanjin", regionLabel: "부산진구", neighborhoods: ["서면", "부전동", "전포동"], caseAngle: "서면 상가·오피스 등기", linkedNeighborhoodSlugs: ["서면법무사", "전포동법무사", "양정동법무사", "연지동법무사", "개금동법무사"] },
  { slug: "남구법무사", pageType: "region-hub", serviceSlug: "corporate-registration", regionKey: "namgu", regionLabel: "남구", neighborhoods: ["대연동", "용호동", "문현동"], caseAngle: "문현금융단지 인근 법인등기", linkedNeighborhoodSlugs: ["대연동법무사", "문현동법무사", "용호동법무사", "우암동법무사"] },
  { slug: "금정구법무사", pageType: "region-hub", serviceSlug: "inheritance-registration", regionKey: "geumjeong", regionLabel: "금정구", neighborhoods: ["부곡동", "서동", "금사동"], caseAngle: "금정구 다가구주택 상속등기", linkedNeighborhoodSlugs: ["부곡동법무사", "구서동법무사", "장전동법무사"] },
  { slug: "북구법무사", pageType: "region-hub", serviceSlug: "personal-rehabilitation", regionKey: "buk", regionLabel: "북구", neighborhoods: ["덕천동", "화명동", "구포동"], caseAngle: "북구 거주 개인회생·상속 상담", linkedNeighborhoodSlugs: ["덕천동법무사", "화명동법무사", "구포동법무사"] },
  { slug: "기장군법무사", pageType: "region-hub", serviceSlug: "inheritance-registration", regionKey: "gijang", regionLabel: "기장군", neighborhoods: ["기장읍", "정관읍", "일광읍"], caseAngle: "기장군 토지·전원주택 상속", linkedNeighborhoodSlugs: ["정관법무사", "일광읍법무사", "기장읍법무사", "오시리아법무사"] },
