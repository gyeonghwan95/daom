...
export const conversionTopics: Record<string, ConversionTopic> = {
  "lawyer-fee-busan": {
    ...
    costFactors: [
      "수임료(보수)·등록면허세·취득세·국민주택채권·인지·등기신청수수료는 항목이 다릅니다.",
      "사건 유형(상속·부동산·법인·회생)과 난이도에 따라 보수가 달라집니다.",
      "부동산 가액·채무 규모·상속인 수·공동명의·말소 병행 여부가 영향을 줍니다.",
      "보정·출장·복대리·재접수 등이 있으면 추가 비용이 생길 수 있습니다.",
      "견적 시 알려야 할 정보: 등기부·계약·기한·명의·대출·채무 규모.",
      "고정 단가를 일률 공시하지 않으며, 상담 후 항목별로 안내합니다.",
    ],
    timelineNotes: [
      "상담 후 수임료와 공과금을 구분해 안내합니다.",
      "대한법무사협회 보수 기준은 참고용이며 사건별 조정이 있을 수 있습니다. → /부산법무사보수표",
      "영수증·납부자료로 실제 납부 항목을 확인하는 것이 좋습니다.",
    ],
    documentList: [
      "등기부등본 또는 부동산·법인 정보",
