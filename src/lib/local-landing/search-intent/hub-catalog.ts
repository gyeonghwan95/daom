...
const EXISTING_GUIDE_ENTRIES: SearchGuideEntry[] = [
  ...
  { label: "부산 등기전문 법무사", href: "/부산등기전문법무사", category: "expertise", existing: true },
  { label: "부산 상속전문 법무사", href: "/부산상속전문법무사", category: "expertise", existing: true },
  { label: "부산 법인전문 법무사", href: "/부산법인전문법무사", category: "expertise" },
  { label: "부산 개인회생전문 법무사", href: "/부산개인회생전문법무사", category: "expertise" },
  { label: "부산 매매등기전문 법무사", href: "/부산매매등기전문법무사", category: "expertise" },
  { label: "부산 한정승인전문 법무사", href: "/부산한정승인전문법무사", category: "expertise" },
  { label: "부산 회생전문 법무사", href: "/부산회생전문법무사", category: "expertise" },
  { label: "부산 파산전문 법무사", href: "/부산파산전문법무사", category: "expertise" },
  { label: "부산 상속포기전문 법무사", href: "/부산상속포기전문법무사", category: "expertise" },
