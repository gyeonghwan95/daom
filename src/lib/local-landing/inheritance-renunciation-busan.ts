...
export function buildBusanInheritanceRenunciationPage(
  ...
  return {
    ...
    extraPageSections: [
      ...
      {
        title: "상속포기 3개월 일정표",
        body: "달력에는 사망일과 인지일을 따로 적습니다. 아래는 상담 전 일정 메모이며, 개별 기한은 사실관계에 따라 달라질 수 있습니다.",
        items: [
          "오늘 기준: 인지일부터 며칠이 지났는지",
          "앞으로 14일: 가족관계·채무 통지 수집",
          "앞으로 한 달: 포기 vs 한정 방향",
          "3개월 만료 전: 가정법원 신고 서류 제출",
          "신고 후: 보정·심판 확인, 다른 상속인 안내",
        ],
        links: [
          {
      ...
      {
        title: "미성년·해외 상속인이 있을 때 준비표",
        body: "부모만 포기해도 미성년 자녀 몫은 남을 수 있습니다. 해외 거주 상속인은 위임·인증 일정이 3개월과 겹치는지 먼저 봅니다. 자동으로 함께 포기된다고 보지 않습니다.",
        items: [
      ...
      {
        title: "가정법원 신고 이후 확인할 일",
        body: `다옴법무사사무소는 ${officeLocation.fullAddress}에 있으며, 안윤정 법무사가 보정·심판 안내와 다른 상속인 일정을 정리합니다. 신고 전에는 상속인 확인 → 3개월 기한 → 재산·채무·처분 → 포기 vs 한정 → 서류 → 가정법원 순으로 맞춥니다. 소송 대리·세무 확정은 업무 범위가 아닙니다.`,
        items: [
