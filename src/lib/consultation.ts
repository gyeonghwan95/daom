export const consultationCopy = {
  default:
    "등기와 법률 절차는 상황에 따라 필요한 서류와 순서가 달라질 수 있습니다. 약 1분이면 상담 신청을 남길 수 있으며, 다옴법무사사무소 안윤정 법무사가 현재 상황을 차분히 확인해 드리겠습니다.",
  contact:
    "전화, 카카오톡, 네이버 톡톡 중 편한 방법으로 연락해 주세요. 약 1분이면 온라인 상담 신청도 가능합니다. 사무소 방문은 예약 후 이용해 주시며, 개인정보는 사이트에 저장되지 않습니다.",
  inline:
    "절차나 서류가 막막하시면 편하게 문의해 주세요. 약 1분이면 상담 신청을 남길 수 있습니다. 다옴법무사사무소 안윤정 법무사가 확인해 드립니다.",
  inquiryNotice:
    "약 1분이면 상담 신청을 완료할 수 있습니다. 사무소 방문 예약은 네이버 예약으로 신청하실 수 있습니다. 사이트에는 개인정보를 저장하지 않습니다.",
  feeNotice:
