...
export const topicHubConfigs: TopicHubConfig[] = [
  {
    ...
    intro:
      "상속이 발생하면 등기·가정법원 신고·채무 조사를 어떤 순서로 진행해야 할지 막막한 경우가 많습니다. 부동산이 부산에 있지 않아도 전국 상속등기를 상담할 수 있고, 상속포기·한정승인은 법정 관할을 지키면서 비대면으로 진행할 수 있습니다. 상속 개시 후 3개월은 주로 포기·한정승인 검토와 관련된 기간이며, 상속등기·취득세 신고기한과 혼동하지 않도록 구분해 안내합니다. 다옴법무사사무소는 전화·카카오톡·방문(예약)으로 상담하며 필요 서류와 비용을 항목별로 설명합니다. 원본서류·본인확인·해외서류가 필요하면 사건별로 추가 절차를 안내하며, 모든 사건이 완전 비대면이라고 단정하지 않습니다.",
    ctaDescription:
