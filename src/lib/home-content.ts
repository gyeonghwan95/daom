export const homeHero = {
  ...
  sub: "부산에서 법무사를 찾고 있다면 필요한 업무명부터 정확히 알고 오실 필요는 없습니다. 다옴법무사사무소 안윤정 법무사가 상속등기·부동산등기·법인등기·개인회생·파산 등 현재 상황을 확인하고 필요한 절차와 준비서류부터 안내합니다. 사무소는 부산 해운대구 센텀에 있습니다.",
  promise: "서류 준비 전에도 · 법무사 직접 상담",
  proof: ["법무사 직접 상담", "대한법무사협회장 표창", "해운대·센텀 실사무소"] as const,
