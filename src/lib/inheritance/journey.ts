...
export const INHERITANCE_PAGE_STAGE: Record<string, string> = {
  ...
  전국상속등기: "remote-cost",
  방문없이준비하는법무사업무: "remote-cost",
  상속인이여러지역에있는경우: "remote-cost",
  부동산과거주지가다른상속등기: "remote-cost",
  방문없이준비하는상속포기한정승인: "choice",
  사진전자파일우편으로서류전달: "remote-cost",
  법무사비용먼저확인하는방법: "remote-cost",
  사업자폐업후법인정리: "remote-cost",
  등기권리증없이소유권이전: "remote-cost",
  해외서류가필요한증여등기: "remote-cost",
  방문없이준비하는부담부증여: "remote-cost",
  공유물분할등기서류준비: "remote-cost",
