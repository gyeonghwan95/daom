...
export const CONSULT_LANDINGS: ConsultLandingContent[] = [
  ...
  },
  {
    ...
    metaTitle: "무슨 법률 업무인지 모를 때｜상황 선택 상담",
    metaDescription:
      "업무명을 몰라도 현재 상황만 선택해 법무사에게 문의할 수 있습니다.",
    h1: "무슨 법률 업무인지 몰라도 괜찮습니다",
    eyebrow: "상황 중심 상담",
    paragraphs: [
      "검색어와 실제 필요한 절차가 다를 수 있습니다. 지금 겪고 있는 일을 선택해 주시면 됩니다.",
    ],
    bullets: ["업무명 몰라도 진행", "여러 상황 복수 선택", "이후 절차 안내"],
    prepItems: ["현재 상황", "연락처"],
    faqs: [
      {
