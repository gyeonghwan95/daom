...
export function getNationwideNotice(
  ...
  if (type === "jurisdiction-exception") {
    return {
      type,
      badge: "전국 의뢰 가능",
      title: "부산에 방문하지 않아도 전국 상속·유증등기를 진행할 수 있습니다",
      paragraphs: [
        "서울·경기·인천·대구·대전·광주·울산·경남·경북·전남·전북·충남·충북·강원·제주 등 부동산 소재 지역과 관계없이 바로 상담을 시작할 수 있습니다.",
        "상속·유증등기는 관할 특례가 적용되는 범위에서 부동산 소재지와 다른 지역의 등기소를 통해 신청까지 이어갈 수 있습니다. 여러 지역에 부동산이 흩어져 있어도 서류 수집부터 신청까지 한 사무소에서 진행합니다.",
      ],
      steps: BASE_STEPS,
      caution:
  ...
  if (type === "bundled-jurisdiction") {
    return {
      type,
      badge: "전국 의뢰 가능",
      title: "여러 지역 부동산이라도 한 흐름으로 진행할 수 있습니다",
      paragraphs: [
        "당사자·등기목적·등기원인과 신청 구조가 일정한 요건을 충족하면 하나의 관할에서 함께 신청까지 진행할 수 있습니다.",
        "무조건 일괄 접수된다고 단정하지 않으며, 사건별 요건을 확인한 뒤 가능한 방식으로 끝까지 안내합니다.",
      ],
      steps: BASE_STEPS,
      caution:
        "복수 관할 부동산의 공동담보·관련 등기는 요건에 따라 신청 방식이 달라질 수 있습니다. 개별 사건은 서류 확인이 필요합니다.",
      ctaLabel: options?.ctaLabel ?? "여러 지역 부동산 바로 문의하기",
      ctaHref,
    };
  }
  ...
  if (type === "expandable-jurisdiction") {
    return {
      type,
      badge: "전국 의뢰 가능",
      title: "지역이 달라지는 법인 본점이전도 비대면으로 진행할 수 있습니다",
      paragraphs: [
        "관할 외 본점이전등기는 종전 본점과 새 본점 소재지의 관할을 확인하여 접수까지 진행합니다.",
        "부산으로 이전하는 법인뿐 아니라 부산에서 타지역으로 이전하는 법인도 전화·카카오톡으로 상담하고 끝낼 수 있습니다.",
      ],
      steps: BASE_STEPS,
      caution:
  ...
  return {
    type,
    badge: "전국 의뢰 가능",
    title: "사무소와 거리가 있어도 비대면으로 업무를 끝까지 진행할 수 있습니다",
    paragraphs: [
      "다옴법무사사무소는 부산에 있지만 타지역 의뢰도 전화·카카오톡·전자문서·우편을 활용해 상담부터 신청까지 진행할 수 있습니다.",
      "신청은 사건별 법정 관할 법원 또는 등기소에 이루어집니다. 방문이 필요한 절차가 있으면 수임 전에 미리 안내하니, 부담 없이 먼저 연락해 주세요.",
    ],
    steps: BASE_STEPS,
    caution:
...
export const nationwideServiceCards: NationwideServiceCard[] = [
  ...
  },
  {
    ...
    jurisdictionNote: "부동산별 등기부·시가·취득세 신고를 묶어 진행합니다.",
  ...
  },
  {
    ...
    href: "/전국법인본점이전등기",
    summary: "서울↔부산·김해·양산 등 타지역 이전을 비대면으로 끝까지 진행합니다.",
  },
  {
    id: "joint-collateral",
    name: "전국 공동담보·근저당",
    ...
    href: "/전국공동담보등기",
    summary: "서로 다른 지역 부동산을 공동담보로 제공하는 경우를 진행합니다.",
  },
  {
    id: "remote-corp",
    name: "법인설립·변경등기",
    ...
    href: "/법인등기",
    summary: "법정 관할은 지키되 타지역 법인도 비대면으로 끝까지 진행합니다.",
  },
  {
    ...
    summary: "3개월 검토 기간을 지키며 타지역 신고도 비대면으로 진행합니다.",
  },
  {
    id: "remote-rehab",
    name: "개인회생·개인파산",
