...
```
NEXT_PUBLIC_SITE_URL=https://daom-law.com
...
4. 환경 변수 `NEXT_PUBLIC_SITE_URL=https://daom-law.com` 확인 후 재배포
...
2. **속성 추가** → URL 접두어: `https://daom-law.com`
3. 소유권 확인 (HTML 파일 업로드 또는 DNS TXT 레코드)
   - HTML 파일 방식: `public/` 에 확인 파일 추가 → push → 배포 후 확인
4. **Sitemaps** → `https://daom-law.com/sitemap.xml` 제출
5. **robots.txt** 확인: `https://daom-law.com/robots.txt`
